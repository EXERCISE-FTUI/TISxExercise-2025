...
const handleNextDivision = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[70%] md:h-[85%] lg:h-[80%]">
      {/* Title */}
        ...
        <div className="flex justify-between place-self-center gap-4 w-[45%] mt-4">
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`font-bold md:w-[85%] w-1/2 lg:w-[70%] rounded-xl bg-[#C7E7F8] md:py-2 text-center font-poppins not-italic drop-shadow-[2px_5px_5px_#576972] transition-all duration-300 hover:bg-[#383F96] hover:text-white transform hover:scale-105 ${
      ...
      <div className="relative mx-auto mt-5 max-w-full sm1:max-w-screen-sm1 md:max-w-screen-md lg:max-w-screen-lg rounded-xl bg-white/10 text-white backdrop-blur-sm1">
        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-x-4 px-0 md:pr-[6%] md:pt-3">
          ...
          <div className="md:block hidden mr-[30%]">
            <ImagePaginationDots />
          </div>
          <PaginationDots />
        </div>
