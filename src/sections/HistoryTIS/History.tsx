    ...
    <div id="historytis" className="w-screen mt-7 md:mt-12">
      <div className="relative flex justify-center">
        <Image
          ...
          width={1000}
          height={500}
          className="w-68 md:w-[1000px] relative z-10 -mb-[30px] md:-mb-[110px] mr-25 md:mr-90"
        />
      </div>
      ...
      <div className="bg-[#DCF0FA] pt-[100px] pb-15 md:pb-35">
        <div className="flex flex-col items-center">
          <Image
            ...
            width={275}
            height={0}
            className="w-20 md:w-[275px] relative z-30 -mt-[115px] md:-mt-[177px] ml-69 md:ml-270"
          />
          ...
          <div className="flex flex-col items-center md:mt-15 mr-10 md:mr-0 md:ml-20">
            <Image
              src="/assets/History/images/2013.png"
              alt="2013"
              width={180}
              height={180}
              className="w-15 md:w-[180px] ml-67 md:ml-240"
            />
            <div className="ml-2 md:ml-0">
              <div className="text-xl md:text-[3.5rem] font-bold text-shadow-lg text-[#383A85] mr-18 md:mr-0 -mt-[25px] md:-mt-[75px] text-right">
                Perpustakaan Terbuka
              </div>
              <div className="text-xs md:text-[2rem] w-[320px] md:w-[500px] text-[#383A85] md:ml-50 leading-normal mt-1 md:mt-0 text-right">
          ...
          <div className="flex flex-col items-center mt- md:mt-6">
            <Image
              src="/assets/History/images/2014.png"
              alt="2014"
              width={180}
              height={180}
              className="w-15 md:w-[180px] mr-59 md:mr-245"
            />
            <div className=" md:mr-32">
              <div className="text-xl md:text-[3.5rem] font-bold text-shadow-lg text-[#383A85] ml-20 md:ml-0 -mt-6 md:-mt-[67px] text-left">
                Pasar Minggu
              </div>
              <div className="text-xs md:text-[2rem] w-75 md:w-[600px] text-[#383A85] mt-1 md:mt-0 leading-normal text-left">
          ...
          <div className="flex flex-col items-center ml-8 md:ml-20 md:mt-0">
            <Image
              src="/assets/History/images/2015.png"
              alt="2015"
              width={180}
              height={180}
              className="w-15 md:w-[180px] ml-50 md:ml-240"
            />
            <div className="ml-10 md:ml-15">
              <div className="text-xl md:text-[3.5rem] font-bold text-shadow-lg text-[#383A85] mr-17 md:mr-0 -mt-6 md:-mt-[72px] text-right">
                Promosi
              </div>
              <div className="text-xs md:text-[2rem] md:w-[450px] text-[#383A85] md:ml-50 leading-normal text-right">
          ...
          <div className="flex flex-col items-center md:mt-6">
            <Image
              ...
              className="w-15 md:w-[180px] mr-59 md:mr-245"
            />
            <div className="mr-25 md:mr-58">
              <div className="text-xl md:text-[3.5rem] font-bold text-shadow-lg text-[#383A85] ml-20 md:ml-0 -mt-6 md:-mt-[70px] text-left">
                Manara
              </div>
              <div className="text-xs md:text-[2rem] w-50 md:w-[500px] mt-1 md:mt-0 text-[#383A85] leading-normal text-left">
          ...
          <div className="flex flex-col items-center ml-8 md:ml-20 mt-1.5 md:mt-0">
            <Image
              ...
              className="w-15 md:w-[180px] ml-50 md:ml-240"
            />
            <div className="mr-48 md:mr-0 md:ml-15">
              <div className="text-xl md:text-[3.5rem] font-bold text-shadow-lg text-[#383A85] mr-17 md:mr-0 -mt-6 md:-mt-[70px] text-right">
                Daops Baru
              </div>
              <div className="text-xs md:text-[2rem] w-[450px] text-[#383A85] md:ml-50 leading-normal text-right">
